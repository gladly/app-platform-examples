...
{{- else if .rawData.data.updateSubscriptionNote -}}
{{- $payload := .rawData.data.updateSubscriptionNote -}}
...
{{- end -}}
{{- else -}}
{{- fail "Unexpected response structure from Skio API for updateSubscriptionNote" -}}
{{- end -}}
