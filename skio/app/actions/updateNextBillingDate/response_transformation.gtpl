...
{{- else if .rawData.data.updateNextBillingDate -}}
{{- $payload := .rawData.data.updateNextBillingDate -}}
...
{{- end -}}
{{- else -}}
{{- fail "Unexpected response structure from Skio API for updateNextBillingDate" -}}
{{- end -}}
