...
{{- else if .rawData.data.updateSubscriptionLine -}}
{{- $payload := .rawData.data.updateSubscriptionLine -}}
...
{{- end -}}
{{- else -}}
{{- fail "Unexpected response structure from Skio API for updateSubscriptionLine" -}}
{{- end -}}
