...
{{- else if .rawData.data.changeSubscriptionDeliveryMethod -}}
{{- $payload := .rawData.data.changeSubscriptionDeliveryMethod -}}
{ "ok": true }
{{- else -}}
{{- fail "Unexpected response structure from Skio API for changeSubscriptionDeliveryMethod" -}}
{{- end -}}
