...
{{- else if .rawData.data.setDeliveryPriceOverride -}}
{{- $payload := .rawData.data.setDeliveryPriceOverride -}}
...
{{- else -}}
{{- fail "Unexpected response structure from Skio API for setDeliveryPriceOverride" -}}
{{- end -}}
