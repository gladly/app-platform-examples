...
{{- else if .rawData.data.updateSubscriptionLineBulk -}}
{{- $payload := .rawData.data.updateSubscriptionLineBulk -}}
...
{{- end -}}
{{- else -}}
{{- fail "Unexpected response structure from Skio API for updateSubscriptionLineBulk" -}}
{{- end -}}
