...
{{- else if .rawData.data.swapSubscriptionProductVariants -}}
{{- $payload := .rawData.data.swapSubscriptionProductVariants -}}
...
{{- end -}}
{{- else -}}
{{- fail "Unexpected response structure from Skio API for swapSubscriptionProductVariants" -}}
{{- end -}}
