...
{{- end -}}
{
  "title": "Update subscription note",
{{- if gt (len $options) 0}}
...
{{- if gt (len $options) 0}}
    ...
    },
    {
      ...
      "label": "Note",
      "attr": "note",
      "input": {"type": "text", "placeholder": "Customer prefers Friday delivery", "optional": true},
      "hint": "Replaces the existing note. Leave it blank to clear the note."
    }
{{- else}}
    {
      "type": "text",
      "text": "This customer has no Skio subscriptions."
    }
{{- end}}
  ]
}
