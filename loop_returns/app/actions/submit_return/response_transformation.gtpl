...
{ "ok": true, "state": {{ coalesce .rawData.draft_return.state "submitted" | toJson }}, "returnId": "{{ if and (hasKey .rawData "draft_return") (hasKey .rawData.draft_return "return_id") }}{{ int64 .rawData.draft_return.return_id }}{{ else }}0{{ end }}" }
