...
{{- else if .rawData.data.unpauseSubscription -}}
{{- $payload := .rawData.data.unpauseSubscription -}}
...
{{- end -}}
{{- else -}}
{{- fail "Unexpected response structure from Skio API for unpauseSubscription" -}}
{{- end -}}
