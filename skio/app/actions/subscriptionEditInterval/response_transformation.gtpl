...
{{- else if .rawData.data.subscriptionEditInterval -}}
{{- $payload := .rawData.data.subscriptionEditInterval -}}
...
{{- else -}}
{{- fail "Unexpected response structure from Skio API for subscriptionEditInterval" -}}
{{- end -}}
