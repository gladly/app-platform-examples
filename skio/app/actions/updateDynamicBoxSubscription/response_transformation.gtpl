...
{{- else if .rawData.data.updateDynamicBoxSubscription -}}
{{- $payload := .rawData.data.updateDynamicBoxSubscription -}}
...
{{- end -}}
{{- else -}}
{{- fail "Unexpected response structure from Skio API for updateDynamicBoxSubscription" -}}
{{- end -}}
