...
{{- else if .rawData.data.reactivateSubscription -}}
{{- $payload := .rawData.data.reactivateSubscription -}}
...
{{- end -}}
{{- else -}}
{{- fail "Unexpected response structure from Skio API for reactivateSubscription" -}}
{{- end -}}
