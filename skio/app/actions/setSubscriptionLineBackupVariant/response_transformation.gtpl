...
{{- else if .rawData.data.setSubscriptionLineBackupVariant -}}
{{- $payload := .rawData.data.setSubscriptionLineBackupVariant -}}
...
{{- end -}}
{{- else -}}
{{- fail "Unexpected response structure from Skio API for setSubscriptionLineBackupVariant" -}}
{{- end -}}
