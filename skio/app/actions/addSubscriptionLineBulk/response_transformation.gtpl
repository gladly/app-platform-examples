...
{{- else if .rawData.data.addSubscriptionLineBulk -}}
{{- $payload := .rawData.data.addSubscriptionLineBulk -}}
...
{{- end -}}
{{- else -}}
{{- fail "Unexpected response structure from Skio API for addSubscriptionLineBulk" -}}
{{- end -}}
