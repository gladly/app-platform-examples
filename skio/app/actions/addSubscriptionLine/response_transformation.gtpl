...
{{- else if .rawData.data.addSubscriptionLine -}}
{{- $payload := .rawData.data.addSubscriptionLine -}}
...
{{- end -}}
{{- else -}}
{{- fail "Unexpected response structure from Skio API for addSubscriptionLine" -}}
{{- end -}}
