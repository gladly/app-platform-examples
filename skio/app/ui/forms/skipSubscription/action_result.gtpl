...
{{- else -}}
{{- $next := .action.result.nextBillingDate | default "" | toString -}}
{{- $detailText := "The next order was skipped." -}}
{{- if ne $next "" -}}
    {{- $detailText = printf "The next order was skipped. The subscription now bills on %s." $next -}}
{{- end -}}
{
