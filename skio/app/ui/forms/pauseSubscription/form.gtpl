...
{{- if gt (len $options) 0}}
  "submitButton": "Pause subscription",
{{end -}}
  "closeButton": "Close",
  "sections": [
{{- if gt (len $options) 0}}
    ...
    },
    {
      ...
      "hint": "Advanced. Leave blank for an open-ended pause the agent lifts later."
    },
    {
      "type": "input",
      "label": "Pause window length",
      "attr": "skipValue",
...
{{- else}}
    {
      "type": "text",
      "text": "This customer has no active Skio subscriptions to pause."
    }
{{- end}}
  ]
}
